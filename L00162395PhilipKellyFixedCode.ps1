...
this, so the Network-Tests function is changed to NetworkTest throught the code.
...
<#
PHILIPS NOTES
Changed the function name fromm  Check-WarningsErrors into CheckWarningsErrors due to unapproved verb warning
#>
